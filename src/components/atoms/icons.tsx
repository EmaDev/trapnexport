 ...
 *
 *  Es el único ícono del archivo que no pasa por `Icon`, y no por capricho:
 *  `Icon` dibuja trazos en `currentColor` sobre relleno transparente, y este
 *  logo es exactamente lo contrario —cuatro rellenos de colores fijos—. Las
 *  condiciones de uso de "Sign in with Google" tampoco admiten recolorearlo:
 *  o va con sus colores o va en blanco y negro, nunca teñido del color del
 *  botón que lo contiene.
 */
export const GoogleIcon = (p: IconProps) => (
  <svg viewBox="0 0 48 48" aria-hidden="true" focusable="false" width="1.25em" height="1.25em" {...p}>
    <path
      fill="#4285F4"
...
/** Salida: una puerta con la flecha yéndose. Es el de "cerrar sesión". */
export const LogoutIcon = (p: IconProps) => (
  <Icon {...p}>
    <path d="M14.5 4.5H6.8A1.8 1.8 0 0 0 5 6.3v11.4a1.8 1.8 0 0 0 1.8 1.8h7.7" />
    <path d="M18.5 12H10" />
    <path d="m15.5 8.8 3.2 3.2-3.2 3.2" />
  </Icon>
);
